import {SpellAction} from "@/src/models/character/actions/Action";
import {ApiSpellShape, RollSet, EffectRoll, DieFormat, DamageType} from "@/types";
...
function mapDcTypeToAbilityScore(dcType: "dex" | "cha" | "wis" | "con" | "str" | "int"): keyof import("@/types").AbilityScores {
