// import {Welcome} from "@/types/dndBeyondApiType";
//
...
//     let result = new Map<Character, number>;
//
//     // for(const datum of data) {
//     //     const newClass = new CharacterClass({name: datum.subclassDefinition.name, spellCastingModifierBase: datum.subclassDefinition.} )
//     //     result.set()
//     // }
//     // if(result.has())
//
